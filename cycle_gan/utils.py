...
def parse_opt():
    ...
    # image datasets
    parser.add_argument("--data_root_A", type=str, default="cycle_gan/sample/trainA/") # dataset path
    parser.add_argument("--data_root_B", type=str, default="cycle_gan/sample/trainB/") # dataset path
    ...
    parser.add_argument("--sample_save_dir", type=str, default='cycle_gan/test_results/') # only for test.py
